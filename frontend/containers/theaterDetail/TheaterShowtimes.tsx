                    ...
                    {allDates.map((date) => {
                        ...
                        return (
                            <button
                                ...
                                className={`flex flex-col items-center justify-center min-w-[80px] h-16 rounded-lg border transition-all ${
                                    selectedDate === date
                                            ...
                                            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                                                {showtimes.map((st, idx) => (
                                                    <button
                                                        ...
                                                        className={`group relative flex flex-col items-center justify-center py-2 px-2 rounded border transition-all ${
