    ...
    return (
        <section className="relative w-full h-[450px] flex items-center justify-center overflow-hidden">
          ...
          `,
            ...
            {/* Content */}
            <div className="relative z-10 flex flex-col gap-4 text-center max-w-3xl px-4 mt-10">
