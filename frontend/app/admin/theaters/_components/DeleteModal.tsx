...
export function DeleteModal({ isOpen, onClose, onConfirm, theaterName }: DeleteModalProps) {
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        <div className="relative bg-white dark:bg-surface-dark rounded-xl shadow-xl max-w-md w-full p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-bold text-slate-900 dark:text-white">Delete Theater</h2>
          </div>

          <p className="text-slate-600 dark:text-[#b99d9d] mb-6">
            Are you sure you want to delete <span className="font-semibold text-slate-900 dark:text-white">{theaterName}</span>? This action cannot be undone.
          </p>
